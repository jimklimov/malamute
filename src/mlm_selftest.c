...
all_tests [] = {
    ...
    { "mlm_mailbox_simple", NULL, true, false, "mlm_mailbox_simple_test" },
#ifdef MLM_BUILD_DRAFT_API
    { "mlm_proto", mlm_proto_test, false, true, NULL },
    { "mlm_server", mlm_server_test, false, true, NULL },
    { "mlm_client", mlm_client_test, false, true, NULL },
